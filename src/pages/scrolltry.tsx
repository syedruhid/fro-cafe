...
const SmoothStackedPanels: React.FC = () => {
  ...
  const sectionConfigs = [
    { internalScroll: 0.15 }, // HeroSection
    { internalScroll: 0.2 },  // AboutSection
    { internalScroll: 0.15 }, // GallerySection
    { internalScroll: 0.1 },  // ContactSection
  ];
  ...
  useEffect(() => {
    ...
    sectionsRef.current.forEach((section, index) => {
      ...
      tl.to(
        section,
        { zIndex: totalSections + 1, duration: 0.1, ease: "none" },
        position
      );
    });
