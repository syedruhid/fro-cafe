...
const Contact = () => {
  ...
  return (
    <div className="pt-16">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            {contactInfo.map((info, index) => (
              ...
              >
                <div className="inline-flex items-center justify-center w-16 h-16 rounded-full mb-4" style={{ background: '#2d4a3e' }}>
                  <info.icon className="w-8 h-8 text-white" />
                </div>
                <h3 className="text-xl font-semibold mb-2" style={{ color: '#2d4a3e' }}>{info.title}</h3>
                {info.link ? (
                  <a 
                    href={info.link} 
                    className="block" 
      ...
      {/* Contact Form & Hours */}
      <section className="py-16" style={{ background: 'linear-gradient(135deg, #1a2f1f 0%, #2d4a3e 100%)' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              {isSubmitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    ...
                    style={{ background: '#ffd700', color: '#2d4a3e' }}
                  >
