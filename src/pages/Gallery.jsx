...
const Gallery = () => {
  ...
  return (
    <div className="pt-16">
      {/* Hero Section */}
      <section className="relative py-20" style={{ background: 'linear-gradient(135deg, #2d4a3e 0%, #1a2f1f 100%)' }}>
      ...
      <section className="py-16" style={{ background: '#f4f1ea' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl font-bold mb-4" style={{ color: '#2d4a3e', fontFamily: 'Playfair Display, serif' }}>
              Our Gallery
            </h2>
            <p className="text-xl mb-8" style={{ color: '#1a2f1f' }}>
              Discover the authentic German dining experience at Fro
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {categories.map((category) => (
                <button
                  ...
                  style={{
                    background: activeCategory === category.id ? '#2d4a3e' : 'rgba(45, 74, 62, 0.1)',
                    border: activeCategory === category.id ? 'none' : '2px solid #2d4a3e'
                  }}
                >
                  {category.name}
                </button>
